...
ram_util = ram_max1.available / (1024 ** 3)
...
print(f"{red}{logo1}")
print("|------------------------------------------------------------------------|")
print(f"{red}|{red}{'PC 󰍹':<{label_width}} {whoami}@{whoispc}")
print(f"{red}|{red}{'CPU ':<{label_width}} {cpu} x {cores}, util: {cpu_percentage}%")
print(f"{cyan}|{cyan}{'GPU 󰢮':<{label_width}}{gpu}")
print(f"{cyan}|{cyan}{'Shell ':<{label_width}} {shell}")
print(f"{magenta}|{magenta}{'Terminal  ':<{label_width}} {term}")
print(f"{magenta}|{magenta}{'Kernel ':<{label_width}} {platform.release()}")
print(f"{magenta}|{magenta}{'Packages 󰉍 ':<{label_width}} {packages} installed")
print(f"{green}|{green}{'Theme ':<{label_width}} {theme}")
print(f"{green}|{green}{'RAM ':<{label_width}} {ram_max:.1f} GiB ({ram_util:.1f} GiB available)")
print(f"{green}|{green}{'Storage 󱊟':<{label_width}}")
for parts in disks:
...
print(f"{magenta}|{magenta}Uptime   {uptime / 3600:.1f} hours")
print(f"{magenta}|------------------------------------------------------------------------|")
